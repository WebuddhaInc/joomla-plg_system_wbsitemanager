...
# link plugin
  ...
  doRepoLink plugin plugins/system wbsitemanager
  doRepoLink plugin/cli/autoupdate.php cli autoupdate.php
  doRepoLink plugin/language/en-GB/en-GB.plg_system_wbsitemanager.ini administrator/language/en-GB en-GB.plg_system_wbsitemanager.ini
  doRepoLink plugin/language/en-GB/en-GB.plg_system_wbsitemanager.sys.ini administrator/language/en-GB en-GB.plg_system_wbsitemanager.sys.ini
